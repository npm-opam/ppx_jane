(* OASIS_START *)
(* DO NOT EDIT (digest: 8da7217015fc2cf9c920b19a742a4621) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_jane";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_assert", None);
                           FindlibPackage ("ppx_bench", None);
                           FindlibPackage ("ppx_bin_prot", None);
                           FindlibPackage ("ppx_compare", None);
                           FindlibPackage ("ppx_custom_printf", None);
                           FindlibPackage ("ppx_enumerate", None);
                           FindlibPackage ("ppx_expect", None);
                           FindlibPackage ("ppx_fail", None);
                           FindlibPackage ("ppx_fields_conv", None);
                           FindlibPackage ("ppx_here", None);
                           FindlibPackage ("ppx_inline_test", None);
                           FindlibPackage ("ppx_let", None);
                           FindlibPackage ("ppx_pipebang", None);
                           FindlibPackage ("ppx_sexp_conv", None);
                           FindlibPackage ("ppx_sexp_message", None);
                           FindlibPackage ("ppx_sexp_value", None);
                           FindlibPackage ("ppx_typerep_conv", None);
                           FindlibPackage ("ppx_variants_conv", None)
                        ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1834\"N/%\141\017\180z\188m\165&\225\206";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
